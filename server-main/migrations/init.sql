...
VALUES (
    1,   -- Replace with an actual UUID value
    1000,                     -- Replace with the basePrice value
    'Property Name',          -- Replace with the property name
    'Property Type',          -- Replace with the property type
    'Property Address',       -- Replace with the property address
    123.456,                  -- Replace with the latitude position
    789.012,                  -- Replace with the longitude position
    1.234,                    -- Replace with the multiplier value
    'Business Description',   -- Replace with the business description
