...
export default function About() {
  ...
  return (
    <main className="overflow-hidden">
      <div className="bg-[#EFF2FA] relative overflow-hidden">
          ...
          <div className="w-[83.3vw] lg:w-[50vw] h-auto lg:aspect-square relative justify-center lg:justify-normal flex lg:flex-row-reverse lg:pr-[3vw]">
            ...
            >
              ...
              <text className="text-black text-center lg:text-start text-[10px] sm:text-[13px] md:text-[16px] xl:text-[18px] lg:text-[15px] mb-[0px] xl:mb-[30px] lg:mb-[15px] text-poppins">
                We understand that the world of real estate investment is
                dynamic and ever-changing. That's why we've harnessed the power
                of AI-driven prediction technology to provide you with a
                distinct advantage. Use our revolutionary cutting-edge AI
                technology with user friendly interface to create timely
                insights and informed decision making. We combine the best of
                both worlds of expertise and automation by creating a learning
                interface for newcomers of the market, ensuring you receive the
                most comprehensive and well-informed decision.
              </text>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white w-[100vw] py-[20px] sm:py-[25px] md:py-[30px] xl:py-[140px] lg:py-[115px] pl-[8.35vw] lg:pl-[0px] flex flex-col items-start lg:items-center relative overflow-hidden">
          ...
          >
            ...
            <text className="text-black text-[10px] sm:text-[13px] md:text-[16px] xl:text-[16px] lg:text-[13px] mb-[35px] sm:mb-[30px] md:mb-[45px] xl:mb-[30px] lg:mb-[20px] text-poppins text-center">
              ...
              place for the real estate market. We strive to straighten the
              steep learning curve of real estate investment and create a
              friendlier environment for everyone to learn real estate
              investment and we make it our mission to help you achieve your
              real estate investment goals with a wealth of resources and
              guidance to support you at every step.
            </text>
            <div
              className="flex lg:hidden w-full h-auto aspect-[339/165] mt-[15px] sm:mt-[25px] md:mt-[35px] overflow-hidden"
              data-aos="fade-up"
            >
              <div className="flex flex-row bg-white w-auto h-full relative overflow-x-auto gap-[4.16vw] px-[2vw] pb-[2vw]">
                <Profile name={"Amjad"} />
