  ...
  return (
    <main className="bg-[#EFF2FA] relative overflow-hidden">
      <div className="flex flex-col lg:flex-row pb-[15px] sm:pb-[20px] md:pb-[25px] xl:pb-[60px] lg:pb-[20px] pt-[70px] sm:pt-[95px] md:pt-[130px] xl:pt-[75px] lg:pt-[60px] items-center lg:items-start lg:justify-between relative">
        <div className="flex lg:hidden w-[48vw] h-auto aspect-square relative" data-aos="fade-right">
          <Image alt="House" src={house} fill={true} />
        </div>
        <div className="hidden w-[50vw] h-auto aspect-square py-[1vw] relative lg:flex pl-[7.8vw]" data-aos="fade-right">
        ...
        <div className="w-[83.3vw] lg:w-[50vw] h-auto lg:aspect-square relative justify-center lg:justify-normal flex lg:flex-row-reverse lg:pr-[3vw]">
          <div className="flex flex-col lg:justify-center items-center lg:items-start w-[83.3vw] lg:w-[34.74vw]" data-aos="fade-left">
      ...
      <div className="bg-white w-[100vw] py-[20px] sm:py-[25px] md:py-[30px] xl:py-[140px] lg:py-[115px] pl-[8.35vw] lg:pl-[0px] flex flex-col items-start lg:items-center relative overflow-hidden">
        <div className="hidden lg:flex w-[15.23vw] h-auto aspect-[292.5/378.6] absolute top-[-50px] xl:top-[-50px] lg:top-[-35px] left-[-5vw] z-10" data-aos="fade-right">
          <Image alt="About Yellow" src={yellow} fill={true} />
        </div>
        <div className="hidden lg:flex w-[28.75vw] h-auto aspect-[552/398] absolute top-[-50px] xl:top-[-50px] lg:top-[-35px] right-[-10vw] z-10" data-aos="fade-left">
          <Image alt="About Yellow" src={yellow2} fill={true} />
        </div>
        <div className="w-[83.3vw] lg:w-[52.5vw] flex flex-col justify-center items-center lg:mb-[40px]" data-aos="zoom-in">
