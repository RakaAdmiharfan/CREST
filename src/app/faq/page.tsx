...
export default function Faq() {
  return (
    <main className="bg-[#EFF2FA] relative overflow-hidden min-h-[100vh]">
      <div className="flex flex-row pt-[75px] xl:pt-[75px] lg:pt-[60px] justify-between relative">
        ...
        <div className="w-[50vw] h-auto aspect-square relative flex pr-[3vw] items-center justify-center">
          <div className="flex flex-col items-center justify-center">
            <h1 className="text-[#1E2351] font-bold text-[80px] xl:text-[80px] lg:text-[55px] mb-[10px] xl:mb-[10px] lg:mb-[7px] text-montserrat">
              FAQ
            </h1>
            <Question />
          </div>
