      ...
      <div className="bg-slate-100 min-h-[100vh] lg:h-[100vh] pt-[50px] xl:pt-[50px] lg:pt-[40px] pb-[30px] xl:pb-[60px] lg:pb-[50px] ">
        <div className="w-[full] h-auto aspect-[360/230] lg:aspect-[1920/476] flex flex-col justify-center items-center z-10">
          ...
          <div className="flex flex-col items-center">
            <h1 className="z-10 shadow-[0_4px_4px_0px_rgba(0,0,0,0.25)] text-white text-[50px] sm:text-[65px] md:text-[80px] xl:text-[75px] lg:text-[60px] text-montserrat">
              Invest
            </h1>
            <h5 className="z-10 text-[14px] sm:text-[17px] md:text-[20px] xl:text-[18px] lg:text-[15px] text-poppins text-white shadow-[0_4px_4px_0px_rgba(0,0,0,0.25)] text-justify">
        ...
        <div className="flex bg-slate-100 flex-col-reverse lg:flex-row items-center justify-between px-[8.8vw] lg:px-[10.88vw] mt-[20px] sm:mt-[0px] md:mt-[0px] xl:mt-[45px] lg:mt-[35px] z-20">
          <Link
            href="/marketplace"
            className="w-[82.4vw] lg:w-[33.9vw] mt-[20px] sm:mt-[20px] md:mt-[-20px] lg:mt-[0px] h-auto aspect-[289/191] lg:aspect-[651/430] flex flex-col justify-center items-center text-center gap-[14px] sm:gap-[17px] md:gap-[20px] xl:gap-8 lg:gap-[22px] z-40"
          >
          ...
          <Link
            href="/simulasi"
            className="w-[82.4vw] lg:w-[33.9vw] h-auto aspect-[289/191] lg:aspect-[651/430] flex flex-col justify-center items-center text-center gap-[14px] sm:gap-[17px] md:gap-[20px] xl:gap-8 lg:gap-[22px] z-40"
          >
            <h3 className="text-black text-[23px] sm:text-[28px] md:text-[34px] xl:text-[38px] lg:text-[30px] font-semibold text-poppins">
              Simulation
            </h3>
